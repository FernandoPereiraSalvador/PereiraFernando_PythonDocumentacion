...
class WebcamVideoStream:
    def __init__(self):
        ...
        This method initializes the video stream, reads the first frame, and sets the 'stopped' flag to False.
        """
    ...
    def update(self):
        ...
        This method continuously reads frames from the video stream as long as the 'stopped' flag is False.
        :return:
        """
        while True:
            if self.stopped:
    ...
    def stop(self):
        ...
        Set the 'stopped' flag to True, indicating that the video stream should be stopped
        :return: Nothing
        """
        self.stopped = True
